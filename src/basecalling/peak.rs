...
mod tests {
    ...
    fn selects_each_channel_independently_and_falls_back_to_ploc() {
        ...
        assert_eq!(selected[0].position_0based, 2);
        assert_eq!(selected[1].position_0based, 3);
        assert_eq!(selected[2].position_0based, 4);
        assert_eq!(selected[3].position_0based, 3);
