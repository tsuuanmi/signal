...
- rolling SNR annotations are a Signal method and do not alter Apollo-comparable peak calls or variants;
...
`signal.analysis/v6` result, consumes only the documented tags, and exposes no
