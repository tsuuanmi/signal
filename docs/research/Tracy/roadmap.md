...
artifact/quality-aware local contribution       # noisy-region context via ADR-0036, quantitative call signal evidence via ADR-0037, profile availability via ADR-0038, and structural contributor eligibility via ADR-0039; quality/artifact weighting remains research
...
evidence-weighted consensus         # eligibility via ADR-0039, unit-mass accumulation via ADR-0040, mean profiles via ADR-0041, within/between heterogeneity via ADR-0042, and directional profile distance via ADR-0043; validated weighting/interpretation thresholds remain research
