...
Unit tests cover deterministic ordering, indexed evidence, sparse all-reference overlap, explicit reference support at differential loci, filtered variant retention, incompatible scientific identities, and renamed duplicate content.
