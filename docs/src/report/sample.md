...
Projects internal `SampleEvidence` into `signal.sample_evidence/v5`.
...
- Project per-read trace-integrity and post-trim alignment summaries, pairwise overlap/admission metrics, locus state/base/quality, and variant role/base/peaks/quality.
