...
Projects internal `SampleEvidence` into `signal.sample_evidence/v4`.
...
- Project post-trim alignment summaries, pairwise overlap/admission metrics, locus state/base/quality, and variant role/base/peaks/quality.
