...
- Represent one rolling call/sample window with its estimated primary and secondary SNR features.
...
- `SignalWindow`: 0-based half-open call/sample intervals, minimum primary SNR, maximum secondary SNR, and candidate flag.
