...
- Keep called locus observations as state/base/quality plus optional reference-oriented basecall-independent `EvidenceProfile`, existing merged noisy-region membership, and explicit structural nucleotide-contribution state without public implementation coordinates.
