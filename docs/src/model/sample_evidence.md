...
- Keep called locus observations as state/base/quality plus optional reference-oriented basecall-independent `EvidenceProfile` and existing merged noisy-region membership without public implementation coordinates.
