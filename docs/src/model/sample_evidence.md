...
- Represent normalized variant observations with internal deterministic read indexes, eligibility/exclusion reasons, factorized read/eligibility/orientation support topology, and reviewer-facing call evidence: role, reference-oriented base, co-located four-channel heights, and quality.
