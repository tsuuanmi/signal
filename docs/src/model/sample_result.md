...
Defines serializable `signal.sample_evidence/v5` result records.

## Responsibilities

Represent sample identity, shared provenance, the read registry with per-read trace-integrity evidence, pairwise overlap/admission evidence, sparse differential loci, and normalized variant support.
