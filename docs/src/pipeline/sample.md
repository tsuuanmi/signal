...
- Log read, coverage-segment, pairwise-overlap/admission, sparse differential-locus, normalized-variant, retained profile, local noisy-region membership, and aggregate differential-locus topology counts. These remain evidence summaries rather than operational verdicts.
