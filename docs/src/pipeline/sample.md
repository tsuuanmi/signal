...
- Log read, coverage-segment, pairwise-overlap/admission, sparse differential-locus, normalized-variant, retained profile, and aggregate differential-locus topology counts. Locus and variant topology remain evidence summaries rather than operational verdicts.
