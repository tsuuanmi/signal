...
- Draft 2020-12 analysis-v5, basecalls-v1, and sample-evidence-v2 schema validation owned by `scripts/validate_result_schemas.py` and CI, not Rust integration code;
