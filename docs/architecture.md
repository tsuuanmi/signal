...
| `report` | analysis-v7/basecalls-v2/sample-evidence-v5 projection, shared serialization, atomic publish | scientific decisions and compatibility output |
