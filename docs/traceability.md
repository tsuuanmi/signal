...
| `SRS-PHASE-*` | ADR-0052/0054/0055, architecture/invariants, `pipeline.md` promoted phase boundary | no production owner yet; future `src/phase/` + `src/model/phase.rs` only after detector specification | completed descriptive poly-C corpus artifacts plus future promotion/holdout validation required by SRS-PHASE-007 | no production/public contract yet |
