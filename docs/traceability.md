...
| `SRS-SAMPLE-*` | ADR-0023, architecture invariants | `src/sample/`, `src/model/sample_evidence.rs`, `src/pipeline/sample.rs` | sample evidence unit tests, CLI/schema validation, real multi-read review | `signal.sample_evidence/v1` |
